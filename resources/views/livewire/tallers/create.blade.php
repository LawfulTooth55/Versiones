    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Crear nuevo taller</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="nomtaller" type="text" class="form-control" id="nomtaller" placeholder="Nomtaller">@error('nomtaller') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
